// Auto-generated SPA page module for alternate-merge
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:alternateMix.name"
        >
          Alternate & Mix Pages
        </h1>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.multiplePdfs2"
            >
        ...
        <div id="tool-options" class="hidden mt-6">
          <h2 class="text-lg font-semibold text-white mb-4">Files Order</h2>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/alternate-merge-page.js');
