// Auto-generated SPA page module for background-color
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:backgroundColor.name"
        >
          Background Color
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:backgroundColor.subtitle"
        >
          Change the background color of your PDF.
        </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/background-color-page.js');
