// Auto-generated SPA page module for bmp-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:bmpToPdf.name"
        >
          BMP to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:bmpToPdf.subtitle">
          Create a PDF from one or more BMP images.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p class="text-xs text-gray-500" data-i18n="upload.hints.bmpImages">
              BMP images
            </p>
        ...
        <div id="file-controls" class="hidden mt-4 flex gap-3">
          ...
          >
            ...
            <span data-i18n="upload.clearAll">Clear Files</span>
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/bmp-to-pdf-page.js');
