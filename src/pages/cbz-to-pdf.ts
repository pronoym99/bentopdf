// Auto-generated SPA page module for cbz-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:cbzToPdf.name"
        >
          CBZ to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:cbzToPdf.subtitle">
          Convert comic book archives (CBZ/CBR) to PDF format. Supports multiple
          files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:cbzToPdf.acceptedFormats"
            >
              CBZ, CBR files
            </p>
        ...
        <button
          ...
          data-i18n="tools:cbzToPdf.convertButton"
        >
          Convert to PDF
        </button>
      </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/cbz-to-pdf-page.js');
