// Auto-generated SPA page module for change-permissions
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:changePermissions.name"
        >
          Change Permissions
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:changePermissions.subtitle"
        >
        ...
        <div id="tool-options" class="hidden mt-6 space-y-4">
          <div>
            <label
              ...
              >Current Password (if encrypted)</label
            >
            <input
              type="password"
              id="current-password"
          ...
          <div>
            <label
              for="new-owner-password"
              class="block mb-2 text-sm font-medium text-gray-300"
              >New Owner Password</label
            >
            <input
              type="password"
          ...
          <div class="p-4 bg-gray-900 rounded-lg border border-gray-700">
            <h3 class="text-sm font-semibold text-white mb-3">
              Permissions (requires owner password)
            </h3>
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span class="text-sm text-gray-300">Allow Printing</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  class="w-4 h-4 text-indigo-600 bg-gray-700 border-gray-600 rounded focus:ring-indigo-500"
                />
                <span class="text-sm text-gray-300">Allow Copying Text</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  class="w-4 h-4 text-indigo-600 bg-gray-700 border-gray-600 rounded focus:ring-indigo-500"
                />
                <span class="text-sm text-gray-300">Allow Modifying</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  class="w-4 h-4 text-indigo-600 bg-gray-700 border-gray-600 rounded focus:ring-indigo-500"
                />
                <span class="text-sm text-gray-300">Allow Annotating</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  class="w-4 h-4 text-indigo-600 bg-gray-700 border-gray-600 rounded focus:ring-indigo-500"
                />
                <span class="text-sm text-gray-300">Allow Filling Forms</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  class="w-4 h-4 text-indigo-600 bg-gray-700 border-gray-600 rounded focus:ring-indigo-500"
                />
                <span class="text-sm text-gray-300">Allow Page Extraction</span>
              </label>
            </div>
          </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/change-permissions-page.js');
