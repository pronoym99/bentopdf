// Auto-generated SPA page module for combine-single-page
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:combineToSinglePage.name"
        >
          Combine to Single Page
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:combineToSinglePage.subtitle"
        >
        ...
        <div id="tool-options" class="hidden mt-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label
                for="combine-orientation"
                class="block mb-2 text-sm font-medium text-gray-300"
                >Layout Direction</label
              >
              <select
                id="combine-orientation"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div class="flex items-end">
              <label class="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span class="text-sm text-gray-300">Add Separator Lines</span>
              </label>
            </div>
          </div>
          ...
          >
            <div>
              <label
                for="separator-thickness"
                class="block mb-2 text-sm font-medium text-gray-300"
                >Separator Thickness</label
              >
              <input
                type="number"
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/combine-single-page-page.js');
