// Auto-generated SPA page module for delete-pages
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:deletePages.name"
        >
          Delete Pages
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:deletePages.subtitle">
        ...
        <div id="delete-options" class="hidden mt-6">
          ...
          <label
            ...
            >Enter pages to delete (e.g., 2, 4-6, 9):</label
          >
          <input
            type="text"
            id="pages-to-delete"
          ...
          />
          <div
            id="delete-pages-preview"
            class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 my-6"
          ></div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/delete-pages-page.js');
