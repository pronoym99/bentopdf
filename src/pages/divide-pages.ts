// Auto-generated SPA page module for divide-pages
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:dividePages.name"
        >
          Divide Pages
        </h1>
        ...
        <div id="tool-options" class="hidden mt-6">
          <div class="p-3 bg-gray-900 rounded-lg border border-gray-700 mb-4">
            ...
            >
              <li>
                <strong>Vertical:</strong> Split each page into left and right
                halves.
              </li>
              <li>
                <strong>Horizontal:</strong> Split each page into top and bottom
                halves.
              </li>
              <li>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/divide-pages-page.js');
