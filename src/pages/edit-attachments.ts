// Auto-generated SPA page module for edit-attachments
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:editAttachments.name"
        >
          Edit Attachments
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:editAttachments.subtitle"
        >
          View or remove attachments in your PDF.
        </p>
        ...
        <div id="tool-options" class="hidden mt-6">
          <h2 class="text-lg font-semibold text-white mb-3">Attachments</h2>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/edit-attachments-page.js');
