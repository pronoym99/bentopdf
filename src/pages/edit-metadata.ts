// Auto-generated SPA page module for edit-metadata
    ...
    >
      ...
      >
        ...
        <p class="text-gray-400 mb-6" data-i18n="tools:editMetadata.subtitle">
          Change the author, title, and other properties.
        </p>
        ...
        <div id="tool-options" class="hidden mt-6">
          <h2 class="text-lg font-semibold text-white mb-4">Edit Metadata</h2>
          ...
          <div class="mt-6">
            <h3 class="text-md font-semibold text-white mb-2">Custom Fields</h3>
            ...
            <button
              id="add-custom-field"
              type="button"
              class="flex items-center gap-2 mt-3 px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm"
            >
              <i data-lucide="plus" class="w-4 h-4"></i> Add Custom Field
            </button>
          </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/edit-metadata-page.js');
