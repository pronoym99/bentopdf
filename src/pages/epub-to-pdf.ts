// Auto-generated SPA page module for epub-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:epubToPdf.name"
        >
          EPUB to PDF
        </h1>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:epubToPdf.acceptedFormats"
            >
              EPUB files
            </p>
        ...
        <div id="convert-options" class="hidden mt-6">
          <button
            ...
            data-i18n="tools:epubToPdf.convertButton"
          >
            Convert to PDF
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/epub-to-pdf-page.js');
