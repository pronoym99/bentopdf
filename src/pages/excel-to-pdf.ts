// Auto-generated SPA page module for excel-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:excelToPdf.name"
        >
          Excel to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:excelToPdf.subtitle">
          Convert Excel spreadsheets (XLSX, XLS, ODS, CSV) to PDF format.
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:excelToPdf.acceptedFormats"
            >
              XLSX, XLS, ODS, CSV files
            </p>
        ...
        <div id="convert-options" class="hidden mt-6">
          <button
            ...
            data-i18n="tools:excelToPdf.convertButton"
          >
            Convert to PDF
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/excel-to-pdf-page.js');
