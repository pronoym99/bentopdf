// Auto-generated SPA page module for extract-attachments
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:extractAttachments.name"
        >
          Extract Attachments
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:extractAttachments.subtitle"
        >
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.multiplePdfsSupported"
            >
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/extract-attachments-page.js');
