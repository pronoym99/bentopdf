// Auto-generated SPA page module for extract-images
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:extractImages.name"
        >
          Extract Images
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:extractImages.subtitle">
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/extract-images-page.js');
