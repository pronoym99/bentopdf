// Auto-generated SPA page module for extract-pages
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:extractPages.name"
        >
          Extract Pages
        </h1>
        ...
        <!-- Extract Options (shown after file upload) -->
        <div id="extract-options" class="hidden mt-6">
          <p class="mb-2 font-medium text-white">
            Total Pages: <span id="total-pages"></span>
          </p>
          <label
            for="pages-to-extract"
            class="block mb-2 text-sm font-medium text-gray-300"
            >Enter pages to extract (e.g., 2, 4-6, 9):</label
          >
          <input
            type="text"
            id="pages-to-extract"
            class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg p-2.5 mb-6"
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/extract-pages-page.js');
