// Auto-generated SPA page module for fb2-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:fb2ToPdf.name"
        >
          FB2 to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:fb2ToPdf.subtitle">
          Convert FictionBook (FB2) e-books to PDF format. Supports multiple
          files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:fb2ToPdf.acceptedFormats"
            >
              FB2 files
            </p>
          ...
          <input
            ...
            accept=".fb2,application/x-fictionbook+xml,text/xml"
            multiple
          />
        </div>
        ...
        <button
          ...
          data-i18n="tools:fb2ToPdf.convertButton"
        >
          Convert to PDF
        </button>
      </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/fb2-to-pdf-page.js');
