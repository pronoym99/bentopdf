// Auto-generated SPA page module for flatten-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:flattenPdf.name"
        >
          Flatten PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:flattenPdf.subtitle">
          Make form fields and annotations non-editable.
        </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/flatten-pdf-page.js');
