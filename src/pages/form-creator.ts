// Auto-generated SPA page module for form-creator
    ...
    <div class="min-h-screen flex items-center justify-center p-4 bg-gray-900">
      ...
      >
        ...
        <p class="text-gray-400 mb-6" data-i18n="tools:createPdfForm.subtitle">
          Create fillable PDF forms with drag-and-drop text fields.
        </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/form-creator.js');
