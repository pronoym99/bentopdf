// Auto-generated SPA page module for form-filler
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pdfFormFiller.name"
        >
          PDF Form Filler
        </h1>
        <p class="text-gray-400 mb-4">
          Upload a PDF with form fields. Fill them directly in the viewer below,
          then click the button to save and download the filled form. Also
          supports XFA forms.
        </p>

        <div
          class="mb-6 p-3 bg-blue-900/20 border border-blue-700/50 rounded-lg"
        >
          <p class="text-sm text-blue-300">
            <strong>Note on XFA Forms:</strong> XFA (XML Forms Architecture) is
            a legacy format that's only supported by certain PDF viewers like
            BentoPDF and Firefox. If you open an XFA PDF in other software and
            see blank pages or no form fields, it means that viewer doesn't
            support XFA. To view and fill XFA forms properly, use Firefox or
            BentoPDF's Form Filler.
          </p>
        </div>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.pdfWithForms"
            >
        ...
        <div id="form-filler-options" class="hidden mt-6">
          <div
            ...
            class="relative w-full overflow-auto bg-gray-900 rounded-lg border border-gray-600 min-h-[600px]"
          >
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/form-filler-page.js');
