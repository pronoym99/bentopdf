// Auto-generated SPA page module for header-footer
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:headerFooter.name"
        >
          Header & Footer
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:headerFooter.subtitle">
          Add text to the top and bottom of pages.
        </p>
        ...
        <div id="options-panel" class="hidden mt-6 space-y-6">
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/header-footer-page.js');
