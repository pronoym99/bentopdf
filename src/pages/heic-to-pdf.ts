// Auto-generated SPA page module for heic-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:heicToPdf.name"
        >
          HEIC to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:heicToPdf.subtitle">
          Create a PDF from one or more HEIC images.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.heicImages"
            >
              HEIC/HEIF images
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/heic-to-pdf-page.js');
