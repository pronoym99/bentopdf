// Auto-generated SPA page module for image-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:imageToPdf.name"
        >
          Images to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:imageToPdf.subtitle">
          Convert JPG, PNG, BMP, GIF, TIFF, PNM, PGM, PBM, PPM, PAM, JXR, JPX,
          JP2, PSD, SVG, HEIC, WebP to PDF.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p id="supported-formats" class="text-xs text-gray-500">
              JPG, PNG, BMP, GIF, TIFF, PNM, PGM, PBM, PPM, PAM, JXR, JPX, JP2,
              PSD, SVG, HEIC, WebP
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/image-to-pdf-page.js');
