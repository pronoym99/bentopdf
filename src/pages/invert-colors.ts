// Auto-generated SPA page module for invert-colors
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:invertColors.name"
        >
          Invert Colors
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:invertColors.subtitle">
          Create a "dark mode" version of your PDF.
        </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/invert-colors-page.js');
