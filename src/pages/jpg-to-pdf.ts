// Auto-generated SPA page module for jpg-to-pdf
      ...
      >
        ...
        >
          ...
          <input
            ...
            multiple
            accept="image/jpeg, image/jpg, image/jp2, .jp2, .jpx, .jpeg, .jpg"
          />
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/jpg-to-pdf-page.js');
