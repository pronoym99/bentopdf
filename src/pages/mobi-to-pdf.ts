// Auto-generated SPA page module for mobi-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:mobiToPdf.name"
        >
          MOBI to PDF
        </h1>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:mobiToPdf.acceptedFormats"
            >
              MOBI files
            </p>
        ...
        <button
          ...
          data-i18n="tools:mobiToPdf.convertButton"
        >
          Convert to PDF
        </button>
      </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/mobi-to-pdf-page.js');
