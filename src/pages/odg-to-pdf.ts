// Auto-generated SPA page module for odg-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:odgToPdf.name"
        >
          ODG to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:odgToPdf.subtitle">
          Convert OpenDocument Graphics (ODG) files to PDF format. Supports
          multiple files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:odgToPdf.acceptedFormats"
            >
              ODG files
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/odg-to-pdf-page.js');
