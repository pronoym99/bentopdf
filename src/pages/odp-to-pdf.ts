// Auto-generated SPA page module for odp-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:odpToPdf.name"
        >
          ODP to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:odpToPdf.subtitle">
          Convert OpenDocument Presentation (ODP) files to PDF format. Supports
          multiple files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:odpToPdf.acceptedFormats"
            >
              ODP files
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/odp-to-pdf-page.js');
