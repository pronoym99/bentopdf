// Auto-generated SPA page module for ods-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:odsToPdf.name"
        >
          ODS to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:odsToPdf.subtitle">
          Convert OpenDocument Spreadsheet (ODS) files to PDF format. Supports
          multiple files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:odsToPdf.acceptedFormats"
            >
              ODS files
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/ods-to-pdf-page.js');
