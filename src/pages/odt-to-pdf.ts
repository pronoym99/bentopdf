// Auto-generated SPA page module for odt-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:odtToPdf.name"
        >
          ODT to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:odtToPdf.subtitle">
          Convert OpenDocument Text files to PDF format. Supports multiple
          files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.oneOrMoreOdt"
            >
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/odt-to-pdf-page.js');
