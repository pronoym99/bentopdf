// Auto-generated SPA page module for page-numbers
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg p-2.5 focus:ring-indigo-500 focus:border-indigo-500"
              >
                <option value="page_only">1, 2, 3...</option>
                <option value="page_x_of_y">1 / 5, 2 / 5...</option>
              </select>
            </div>
          </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/page-numbers-page.js');
