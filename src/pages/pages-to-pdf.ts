// Auto-generated SPA page module for pages-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pagesToPdf.name"
        >
          Pages to PDF
        </h1>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:pagesToPdf.acceptedFormats"
            >
              Pages files
            </p>
        ...
        <div id="convert-options" class="hidden mt-6">
          <button id="process-btn" class="btn-gradient w-full">
            <span data-i18n="tools:pagesToPdf.convertButton"
              >Convert to PDF</span
            >
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/pages-to-pdf-page.js');
