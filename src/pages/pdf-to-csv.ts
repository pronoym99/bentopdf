// Auto-generated SPA page module for pdf-to-csv
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pdfToCsv.name"
        >
          PDF to CSV
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:pdfToCsv.subtitle">
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/pdf-to-csv-page.js');
