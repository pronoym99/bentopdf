// Auto-generated SPA page module for pdf-to-excel
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pdfToExcel.name"
        >
          PDF to Excel
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:pdfToExcel.subtitle">
          Extract tables from PDF and convert to Excel (XLSX) format.
        </p>
        <div
          id="drop-zone"
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/pdf-to-excel-page.js');
