// Auto-generated SPA page module for pdf-to-markdown
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pdfToMarkdown.name"
        >
          PDF to Markdown
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:pdfToMarkdown.subtitle">
        ...
        <div id="convert-options" class="hidden mt-6 space-y-6">
          <div class="flex items-center gap-3">
            ...
            <label for="include-images" class="text-sm text-gray-300"
              >Include images as base64</label
            >
          </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/pdf-to-markdown-page.js');
