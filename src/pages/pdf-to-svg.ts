// Auto-generated SPA page module for pdf-to-svg
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pdfToSvg.name"
        >
          PDF to SVG
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:pdfToSvg.subtitle">
          Convert each page of a PDF file into a scalable vector graphic (SVG)
          for perfect quality at any size.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p class="text-xs text-gray-500" data-i18n="upload.hints.pdfFiles">
              PDF files
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/pdf-to-svg-page.js');
