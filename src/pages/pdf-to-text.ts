// Auto-generated SPA page module for pdf-to-text
    ...
    <div class="min-h-screen flex items-center justify-center p-4 bg-gray-900">
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pdfToText.name"
        >
          PDF to Text
        </h1>
        <p class="text-gray-400 mb-4" data-i18n="tools:pdfToText.subtitle">
          Extract text from PDF files and save as plain text (.txt). Supports
          multiple files.
        </p>
        <div
          class="bg-amber-900/30 border border-amber-700/50 rounded-lg p-3 mb-6"
        >
          <p class="text-amber-200 text-sm">
            <strong>Note:</strong> This tool works ONLY with digitally created
            PDFs. For scanned documents or image-based PDFs, use our
            <a
              href="ocr-pdf.html"
        ...
        <div class="upload-section mb-6">
          ...
          >
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p
                ...
                data-i18n="upload.hints.pdfFiles"
              >
                PDF files
              </p>
              <p
          ...
          <div id="file-controls" class="hidden mt-4 flex gap-3">
            ...
            >
              ...
              <span data-i18n="upload.clearFiles">Clear Files</span>
            </button>
          </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/pdf-to-text-page.js');
