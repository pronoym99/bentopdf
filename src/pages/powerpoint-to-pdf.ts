// Auto-generated SPA page module for powerpoint-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:powerpointToPdf.name"
        >
          PowerPoint to PDF
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:powerpointToPdf.subtitle"
        >
          Convert PowerPoint presentations (PPTX, PPT, ODP) to PDF format.
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:powerpointToPdf.acceptedFormats"
            >
              PPTX, PPT, ODP files
            </p>
        ...
        <div id="convert-options" class="hidden mt-6">
          <button
            ...
            data-i18n="tools:powerpointToPdf.convertButton"
          >
            Convert to PDF
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/powerpoint-to-pdf-page.js');
