// Auto-generated SPA page module for psd-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:psdToPdf.name"
        >
          PSD to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:psdToPdf.subtitle">
          Convert Adobe Photoshop (PSD) files to PDF format. Supports multiple
          files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:psdToPdf.acceptedFormats"
            >
              PSD files
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/psd-to-pdf-page.js');
