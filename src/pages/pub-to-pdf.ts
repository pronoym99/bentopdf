// Auto-generated SPA page module for pub-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:pubToPdf.name"
        >
          PUB to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:pubToPdf.subtitle">
          Convert Microsoft Publisher (PUB) files to PDF format. Supports
          multiple files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:pubToPdf.acceptedFormats"
            >
              PUB files
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/pub-to-pdf-page.js');
