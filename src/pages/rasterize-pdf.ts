// Auto-generated SPA page module for rasterize-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:rasterizePdf.name"
        >
          Rasterize PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:rasterizePdf.subtitle">
          Convert PDF to image-based PDF. Flatten layers and remove selectable
          text.
        </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/rasterize-pdf-page.js');
