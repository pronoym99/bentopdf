// Auto-generated SPA page module for remove-annotations
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:removeAnnotations.name"
        >
          Remove Annotations
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:removeAnnotations.subtitle"
        >
          Strip comments, highlights, and links.
        </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/remove-annotations-page.js');
