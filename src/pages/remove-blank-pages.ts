// Auto-generated SPA page module for remove-blank-pages
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:removeBlankPages.name"
        >
          Remove Blank Pages
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:removeBlankPages.subtitle"
        >
        ...
        <div id="options-panel" class="hidden mt-6 space-y-4">
          <div>
            <label
              for="sensitivity-slider"
              class="block mb-2 text-sm font-medium text-gray-300"
            >
              Sensitivity: <span id="sensitivity-value">80</span>%
            </label>
            <input
              type="range"
        ...
        <!-- Preview of detected blank pages -->
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/remove-blank-pages-page.js');
