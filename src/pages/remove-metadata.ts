// Auto-generated SPA page module for remove-metadata
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:removeMetadata.name"
        >
          Remove Metadata
        </h1>
        ...
        <div id="tool-options" class="hidden mt-6">
          <div class="p-4 bg-gray-900 rounded-lg border border-gray-700 mb-4">
            ...
            <ul class="text-xs text-gray-400 space-y-1 list-disc list-inside">
              ...
              <li>Document IDs</li>
              <li>PieceInfo (private application data)</li>
            </ul>
          </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/remove-metadata-page.js');
