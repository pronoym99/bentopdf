// Auto-generated SPA page module for remove-restrictions
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:removeRestrictions.name"
        >
          Remove Restrictions
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:removeRestrictions.subtitle"
        >
          Remove password protection and security restrictions associated with
        ...
        <div id="tool-options" class="hidden mt-6 space-y-4">
          <div>
            <label
              for="owner-password-remove"
              class="block mb-2 text-sm font-medium text-gray-300"
              >Owner Password (Optional)</label
            >
            <input
              type="password"
              id="owner-password-remove"
              placeholder="Enter owner password if required"
          ...
          <div class="p-4 bg-gray-900 rounded-lg border border-gray-700">
            ...
            <ul class="text-xs text-gray-400 space-y-1 list-disc list-inside">
              ...
              <li>Copying restrictions</li>
              <li>All other security limitations</li>
            </ul>
          </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/remove-restrictions-page.js');
