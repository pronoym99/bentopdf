// Auto-generated SPA page module for rotate-custom
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:rotateCustom.name"
        >
          ...
          <div class="bg-gray-900 rounded-lg border border-gray-700 p-4 mb-4">
            ...
            <div class="flex justify-center items-center">
              <div class="flex items-center gap-2">
                ...
                <input
                  id="batch-custom-angle"
                  type="number"
                  value="0"
                  class="w-20 h-10 text-center bg-gray-700 border border-gray-600 text-white rounded-lg"
                />
                <button
                  id="batch-increment"
                  class="w-10 h-10 flex items-center justify-center bg-gray-700 hover:bg-gray-600 text-white rounded-lg border border-gray-600"
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/rotate-custom-page.js');
