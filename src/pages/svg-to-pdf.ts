// Auto-generated SPA page module for svg-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:svgToPdf.name"
        >
          SVG to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:svgToPdf.subtitle">
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.svgGraphics"
            >
              SVG Graphics
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/svg-to-pdf-page.js');
