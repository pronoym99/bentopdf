// Auto-generated SPA page module for text-color
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:changeTextColor.name"
        >
          Change Text Color
        </h1>
        <p
          class="text-gray-400 mb-6"
          data-i18n="tools:changeTextColor.subtitle"
        >
          Change the color of text in your PDF.
        </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/text-color-page.js');
