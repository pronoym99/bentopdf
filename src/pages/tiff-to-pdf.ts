// Auto-generated SPA page module for tiff-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:tiffToPdf.name"
        >
          TIFF to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:tiffToPdf.subtitle">
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.tiffImages"
            >
              TIFF images
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/tiff-to-pdf-page.js');
