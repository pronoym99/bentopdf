// Auto-generated SPA page module for view-metadata
...
export const html = `
    ...
    >
      ...
      >
        ...
        <p class="text-gray-400 mb-6" data-i18n="tools:viewMetadata.subtitle">
        ...
        <div id="tool-options" class="hidden mt-6">
          ...
          <div id="metadata-display" class="space-y-3"></div>

          <button id="copy-metadata" class="btn-gradient w-full mt-6">
            <i data-lucide="copy" class="w-4 h-4 inline mr-2"></i> Copy Metadata
            as JSON
          </button>
        </div>
      </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/view-metadata-page.js');
