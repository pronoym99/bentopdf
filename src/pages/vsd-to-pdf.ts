// Auto-generated SPA page module for vsd-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:vsdToPdf.name"
        >
          VSD to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:vsdToPdf.subtitle">
          Convert Microsoft Visio (VSD, VSDX) files to PDF format. Supports
          multiple files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:vsdToPdf.acceptedFormats"
            >
              VSD, VSDX files
            </p>
        ...
        <div id="convert-options" class="hidden mt-6">
          <button id="process-btn" class="btn-gradient w-full">
            <span data-i18n="tools:vsdToPdf.convertButton">Convert to PDF</span>
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/vsd-to-pdf-page.js');
