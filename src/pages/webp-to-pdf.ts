// Auto-generated SPA page module for webp-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:webpToPdf.name"
        >
          WebP to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:webpToPdf.subtitle">
          Create a PDF from one or more WebP images.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="upload.hints.webpImages"
            >
              WebP Images
            </p>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/webp-to-pdf-page.js');
