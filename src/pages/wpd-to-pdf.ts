// Auto-generated SPA page module for wpd-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:wpdToPdf.name"
        >
          WPD to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:wpdToPdf.subtitle">
          Convert WordPerfect documents (WPD) to PDF format. Supports multiple
          files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:wpdToPdf.acceptedFormats"
            >
              WPD files
            </p>
        ...
        <div id="convert-options" class="hidden mt-6">
          <button id="process-btn" class="btn-gradient w-full">
            <span data-i18n="tools:wpdToPdf.convertButton">Convert to PDF</span>
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/wpd-to-pdf-page.js');
