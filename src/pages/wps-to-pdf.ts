// Auto-generated SPA page module for wps-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:wpsToPdf.name"
        >
          WPS to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:wpsToPdf.subtitle">
          Convert WPS Office documents to PDF format. Supports multiple files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:wpsToPdf.acceptedFormats"
            >
              WPS files
            </p>
        ...
        <div id="convert-options" class="hidden mt-6">
          <button id="process-btn" class="btn-gradient w-full">
            <span data-i18n="tools:wpsToPdf.convertButton">Convert to PDF</span>
          </button>
        </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/wps-to-pdf-page.js');
