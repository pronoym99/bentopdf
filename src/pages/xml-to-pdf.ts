// Auto-generated SPA page module for xml-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:xmlToPdf.name"
        >
          XML to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:xmlToPdf.subtitle">
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:xmlToPdf.acceptedFormats"
            >
              XML files
            </p>
        ...
        <button id="process-btn" class="btn-gradient w-full mt-6 hidden">
          <span data-i18n="tools:xmlToPdf.convertButton">Convert to PDF</span>
        </button>
      </div>
    </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/xml-to-pdf-page.js');
