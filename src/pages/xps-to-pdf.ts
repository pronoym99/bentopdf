// Auto-generated SPA page module for xps-to-pdf
    ...
    >
      ...
      >
        ...
        <h1
          ...
          data-i18n="tools:xpsToPdf.name"
        >
          XPS to PDF
        </h1>
        <p class="text-gray-400 mb-6" data-i18n="tools:xpsToPdf.subtitle">
          Convert XPS/OXPS documents to PDF format. Supports multiple files.
        </p>
        ...
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p
              ...
              data-i18n="tools:xpsToPdf.acceptedFormats"
            >
              XPS, OXPS files
            </p>
          ...
          <input
            ...
            accept=".xps,.oxps,application/vnd.ms-xpsdocument,application/oxps"
            multiple
          />
        </div>
        ...
        <button
          id="process-btn"
          class="hidden btn-gradient w-full mt-6"
          data-i18n="tools:xpsToPdf.convertButton"
        >
          Convert to PDF
        </button>
      </div>
...
export async function init(): Promise<void> {
  const mod = await import('../js/logic/xps-to-pdf-page.js');
